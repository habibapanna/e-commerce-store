  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <section className="py-5 bg-white">
        <h2 className="text-4xl font-semibold mb-6 text-center">Shop by Categories</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6">
          {categories.map((category) => (
            ...
            >
              ...
              <p className="text-gray-600">Explore the latest {category.name.toLowerCase()} items</p>
            </div>
          ))}
        </div>
      </section>
